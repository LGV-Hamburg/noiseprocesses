...
class JavaBridge:
    ...
    def _init_classes(self):
        ...
        self.LDENConfig_INPUT_MODE = autoclass(
            "org.noise_planet.noisemodelling.jdbc.LDENConfig$INPUT_MODE"
        )
        self.LDENConfig_TIME_PERIOD = autoclass(
            "org.noise_planet.noisemodelling.jdbc.LDENConfig$TIME_PERIOD"
        )
        self.LDENPropagationProcessData = autoclass(
            "org.noise_planet.noisemodelling.jdbc.LDENPropagationProcessData"
        )
        self.PropagationProcessPathData = autoclass(
            "org.noise_planet.noisemodelling.propagation.PropagationProcessPathData"
        )

        # Database related
        self.ConnectionWrapper = autoclass(
            "org.h2gis.utilities.wrapper.ConnectionWrapper"
        )
        self.GeoJsonDriverFunction = autoclass(
        ...
        self.PowerUtils = autoclass(
            "org.noise_planet.noisemodelling.pathfinder.utils.PowerUtils"
        )
        ...
        self.GeometryTableUtilities = autoclass(
